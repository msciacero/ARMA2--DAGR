...
[QUOTE(ADDON), "Toggle_dagr", {_this spawn FUNC(DAGR_START)}] call CBA_fnc_addKeyHandlerFromConfig;
[QUOTE(ADDON), "Dagr_Menu", {_this spawn FUNC(DAGR_MENU_INIT)}] call CBA_fnc_addKeyHandlerFromConfig;
